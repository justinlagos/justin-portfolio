...
async function run() {
  ...
  await sql`
    ...
    INSERT INTO projects (brand_id, title, slug, type, summary, year, services, featured_image, is_featured, sort_order) VALUES
      ((SELECT id FROM brand_ids WHERE slug = 'take-back-the-mic'), 'Brand Identity and Campaign', 'tbtm-brand-campaign', 'case-study', 'Complete brand identity, digital product, and interactive platform for Africa''s largest music competition.', '2021 to 2024', 'Brand Identity, Digital Product, Campaign, Interactive', NULL, true, 1),
      ((SELECT id FROM brand_ids WHERE slug = 'take-back-the-mic'), 'Access Bank Partnership', 'tbtm-access-bank', 'gallery', 'Brand collateral, debit card design, and social media campaign for the Access Bank x TBTM partnership.', '2022 to 2023', 'Card Design, Brand Collateral, Social Media', NULL, false, 2),
      ...
      ((SELECT id FROM brand_ids WHERE slug = 'kavlr'), 'Product Design and UX', 'kavlr-product', 'case-study', 'End-to-end product design for a digital booking and management platform in the beauty and wellness industry.', '2022 to 2024', 'Product Design, UX/UI, Design System', NULL, true, 1),
      ((SELECT id FROM brand_ids WHERE slug = 'syntech-biofuel'), 'Brand and Campaign', 'syntech-brand', 'case-study', 'Brand identity and campaign design for a sustainable biofuel company.', '2024', 'Brand Identity, Campaign, 3D Visualisation', NULL, true, 1),
      ...
      ((SELECT id FROM brand_ids WHERE slug = 'hashit'), 'App Design and UX', 'hashit-app', 'gallery', 'Product design for a fintech application covering digital asset management, payments, and crypto exchange.', '2023 to 2024', 'Product Design, UX/UI, Fintech', NULL, false, 1),
